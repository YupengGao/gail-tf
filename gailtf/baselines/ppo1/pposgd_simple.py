...
def learn(env, policy_func, *,
    ...
    pi_high = policy_func("pi", ob_space, ac_space) # Construct network for new policy
    pi_low = policy_func("oldpi", ob_space, ac_space)
    oldpi_high = policy_func("oldpi", ob_space, ac_space) # Network for old policy
    oldpi_low = policy_func("oldpi", ob_space, ac_space)
