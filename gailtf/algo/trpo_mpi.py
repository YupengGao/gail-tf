...
def learn(env, policy_func, discriminator, expert_dataset,
    ...
    # need to present two levels of policies
    pi_high = policy_func("pi_high", ob_space, ac_space[0], reuse=(pretrained_weight != None))
    oldpi_high = policy_func("oldpi_high", ob_space, ac_space[0])

    pi_low = policy_func("pi_low", ob_space, ac_space[1], reuse=(pretrained_weight != None))
    oldpi_low = policy_func("oldpi_low", ob_space, ac_space[1])
